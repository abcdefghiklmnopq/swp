    ...
    <body>
        <div class="container right-panel-active" id="container">
            ...
            <div class="form-container sign-up-container">
                <form method="post" action="user/register" class="form" id="register">
                    ...
                    <div class="form__input-group">
                        ...
                        <input type="text" class="form__input" name="fullname" id="displayname" maxlength="20" required="">
                    </div>
                    <div class="form__input-group">
                        <label for="phone"> Moblie: </label>
                        <input type="text" class="form__input" name="phone" id="username" maxlength="20" required="">
                    </div>
                    
                    <div class="form__input-group" style="display: flex;">
                        <label for="gender"> Gender: </label>
                        <div class="row" style="display: flex;">
                        <div> <input class="gender" type="radio" name="gender" value="male"> Male </div>  
                        <div> <input class="gender" type="radio" name="gender" value="female"> Female </div> 
                        <!--<input type="text" class="form__input" name="username" id="username" maxlength="20" required>-->
                        </div>
                    </div> 
                    <div class="form__input-group">
